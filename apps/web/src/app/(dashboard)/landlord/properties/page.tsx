  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-5 flex-wrap gap-3">
        <h1 className="font-display font-bold text-2xl tracking-[-0.02em]">Properties</h1>
      ...
      {!loading && result && result.data.length === 0 && (
        <div className="border-[1.5px] border-dashed border-[var(--line-2)] rounded-2xl py-16 px-5 text-center">
          ...
          <p className="text-sm text-[var(--stone)] mb-4">
            {search || county || propertyType ? "No properties match your filters." : "No properties yet."}
          </p>
          {!(search || county || propertyType) && (
