...
import { PaymentChannelsSection } from "@/components/dashboard/payment-channels-section";

type Tab = "profile" | "payment-channels" | "notifications";
  ...
  return (
    <div>
      ...
      <p className="text-sm text-[var(--stone)] mb-6">
        Save reusable payment channels here; each property&apos;s own page is where you pick which one it actually uses.
      </p>
      ...
      {tab === "payment-channels" && <PaymentChannelsSection />}
